    ...
    where T : struct, Enum
{
    ...
    public static readonly StringOrdinalCaseSensitiveDictionary<Member<T>> s_memberByName;
    ...
    static EnumInfo()
    {
        ...
        s_memberByName = s_members.ToStringOrdinalCaseSensitiveDictionary(static x => x.Name);
        s_memberByValue
            = s_orderedMembers
